import {
  binarySearchValidBlock,
  getTrueLatestBlockNumber,
} from "../src/sync-pending-events";
...
const mockGetEvents = jest.spyOn(
  DelphinusContract.prototype,
  "getPastEventsFromTo"
);
...
describe("test functions in syncEvent works", () => {
  ...
  test("test getPastEventsFromSteped function works case 1", async () => {
    jest.setTimeout(60000); //1 minute timeout
    await DelphinusContract.prototype
